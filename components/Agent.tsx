...
//     const messages =[
//         'What is your name ?',
//         'My name is kishan,nice to meet you!'
//     ];
...
//         <Image src='/user-avatar.png' alt='user avatar' height={540} width={540}
...
// //       setTimeout(() => setCallStatus(CallStatus.ACTIVE), 2000); // simulate connecting
...
// //   return (
// //     <div className="call-view border p-4 rounded-md">
// //       <div className="card-interviewer flex items-center gap-2 mb-4">
...
// //           />
// //           {isSpeaking && <span className="absolute top-0 right-0 w-2 h-2 bg-green-500 rounded-full animate-ping" />}
// //         </div>
// //         <h3>AI Interviewer</h3>
// //       </div>

// //       <div className="card-border p-2 mb-4">
